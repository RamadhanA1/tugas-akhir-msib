    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="col-auto d-flex align-items-center">
                <a href="<?=base_url();?>/admin/Hero"><button class="btn btn-success">< Kembali</button></a>
            </div>
            </div>

            <!-- Tambah hero Form -->
            <form class="row g-3" action="<?php echo site_url('admin/Hero/simpan')?>" method="POST" enctype="multipart/form-data">
                <div class="col-12">
